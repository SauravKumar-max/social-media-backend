...
module.exports = {
	...
	resolve: async (parent, { followingId }, req) => {
		try{
			...
			// const userId = "61ab6dd166500378823ed06d";
			...
			const removeFollower = follwingUser.following.filter(id => id != userId);
			await User.findByIdAndUpdate({ _id: userId }, { following: removeFollowing });
			await User.findByIdAndUpdate({ _id: followingId }, { followers: removeFollower });
